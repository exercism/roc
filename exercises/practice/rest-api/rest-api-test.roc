...
expect {
	database = { users: [] }
	result_json = database->get({ url: "/users", payload: "" })?
	expected_json = "{\"users\": []}"
...
expect {
	database = { users: [] }
	result_json = database->post({ url: "/add", payload: "{\"user\": \"Adam\"}" })?
...
expect {
	...
	result_json = database->get({ url: "/users", payload: "{\"users\": [\"Bob\"]}" })?
...
expect {
	...
	result_json = database->post({ url: "/iou", payload: "{\"amount\": 3.0, \"borrower\": \"Bob\", \"lender\": \"Adam\"}" })?
...
expect {
	...
	result_json = database->post({ url: "/iou", payload: "{\"amount\": 3.0, \"borrower\": \"Adam\", \"lender\": \"Bob\"}" })?
...
expect {
	...
	result_json = database->post({ url: "/iou", payload: "{\"amount\": 2.0, \"borrower\": \"Bob\", \"lender\": \"Adam\"}" })?
...
expect {
	...
	result_json = database->post({ url: "/iou", payload: "{\"amount\": 4.0, \"borrower\": \"Bob\", \"lender\": \"Adam\"}" })?
