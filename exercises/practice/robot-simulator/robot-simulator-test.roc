...
expect {
	result = Robot.create({ x: 0 })  # workaround https://github.com/roc-lang/roc/issues/11024
...
expect {
	robot = Robot.create({ x: 0 })  # workaround https://github.com/roc-lang/roc/issues/11024
	result = robot.move("R")
